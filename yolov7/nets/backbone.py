...
class Backbone(nn.Module):
    def __init__(self, transition_channels, block_channels, n, phi, pretrained=False):
        ...
        ##### 修改1：DCONV #####
        self.stem = nn.Sequential(
            DConv(3, transition_channels, 3, 1),
            DConv(transition_channels, transition_channels * 2, 3, 2),
            DConv(transition_channels * 2, transition_channels * 2, 3, 1),
        )
        ...
        #### 修改3：DBB #####
        # self.dark2 = nn.Sequential(
        #     DiverseBranchBlock(transition_channels * 2, transition_channels * 4, 3, 2),
        #     Multi_Concat_Block(transition_channels * 4, block_channels * 2, transition_channels * 8, n=n, ids=ids),
        # )
