...
from .common import DCNv2, SEAttention, DiverseBranchBlock, RFEM
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False):
        ...
        #333#3 修改3：RFE ######
        # self.conv_for_P5            = RFEM(transition_channels * 16, transition_channels * 8)
        ...
        ####### 修改2：SE_ATT ######
        # self.conv_for_P4            = SEAttention(transition_channels * 8, transition_channels * 4)
...
if __name__ == '__main__':
    ...
    phi = 'l'
    net = YoloBody(anchors_mask, 21, phi, pretrained=False)
    print(net)